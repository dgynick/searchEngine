 ...
 */
public class CrawlDataList implements List<String> {
    ...
    //todo: use binary search to insert, update, and remove
    @Override
    ...
    public boolean add(String s) {
        ...
        System.out.println(String.format("[%d Duplicate Found] not adding '%s'.", ++dupelicates, s));
        return false;
    }
    //todo: use binary search to insert, update, and remove
